% EPDDapFig9.m, uses data from the convergence simulation for various
% parameters that differ from the base line to produce the data in
% fg8DROP.txt
% Produces Figure 9 for the online appendix to Enforcement Policy in and
% Dynamic Model of Deterrence
